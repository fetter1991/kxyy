...
| C19 | 需求登记 #2-7 | 个人资料头像固定不旋转 | 🟢 收尾 | C 组 C1 | 🔲 待排期 2026-08-12 |
| C20 | 需求登记 #2-8 | 音乐播放器初次进入 3 秒自动播放（尊重 autoplay 策略） | 🟡 常规 | T16 | 🔲 待排期 2026-08-12 |
| C21 | 问题反馈 #1-UI-1 | 素材页副标题与标签行间距 | 🟢 收尾 | — | 🔲 待排期 2026-08-12 |
| C22 | 问题反馈 #1-UI-2 | 相册副标题与列表间距 | 🟢 收尾 | — | 🔲 待排期 2026-08-12 |
...
| C26 | 问题反馈 #1-数据-1 | "小猫摇头"视频 orientation 误标 landscape→portrait | 🟢 收尾 | — | 🔲 待排期 2026-08-12 |
...
> C21–C26 为「问题反馈 #1」拆分（2026-08-12），其中 C21/C22/C26 为低风控收尾项，C23/C24/C25 为常规项，均 🔲 待排期，按用户要求仅登记不实施。
