...
| 19.2 | 素材页保留标签 + 16:9 每行 4 张合集卡片 | 中 | G3 / G4 | ⬜ 素材库改为素材合集卡片布局 |
| 19.3 | 素材合集弹窗（左大图预览 / 右标题·作者·列表·说明·下载） | 中 | G5 | ⬜ 左侧大图预览，右侧垂直排布，下载打包合集图片 |
| 19.4 | 相册页封面点击改为平铺瀑布流（保留灯箱） | 中 | A3 / A4 | ⬜ 去掉弹窗，固定宽度瀑布流，保留灯箱 |
